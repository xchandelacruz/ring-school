...
<script type="text/javascript" src="/animation/bubbles/2-style/bubble-animation.js"></script>
    ...
    $(function() {
        ...
        counwl.start();
                        ...
                        <div class="title-courselist">
                            <h1 class="title-h1" style="text-shadow: 0 0 3px #808080, 0 0 5px #000000;">④初心者向けデザインコース</h1> 
                        </div>
    ...
    <div class="container" style="margin-top: 250px !important; margin-bottom: 50px !important;">
        ...
        <div class="row">
            ...
            <div class="font-30">マンツーマンでPhotoshopのスキルを磨きます</div>
...
<br><br><br><br>
            <div><img class="img-responsive " src="/img/courses/single-red-ribbon.png" width="50px" height="100px" class="img-thumbnail" alt="Thumbnail Image" style="float:left"> <p style="font-size: 19px; text-indent: 10px;">Photoshopを主に習得できます。</p>  </div><br><br>
            
                <div><p class="info">ロゴ、名刺、WEBデザイン、すべてがPhotoshopで制作できます。自由にツールを使いこなせる様になりオリジナルのデザインができる人材になりましょう。</p></div>
...
<p class="info">講師は英語を話すフィリピン人です。デザインのついでに英語も勉強ください。</p>
...
<p class="info">プログラミングを学ぶ為の英語を是非学んで頂けたらと思います。</p></div>
...
講師はフィリピン人講師となります。日常会話の英語力を保持されている事が好ましいですが、先述のとおり、このコースは英語の勉強としても活用いただけます。</p>
                ...
                <br>
                <img class="img-responsive " src="/img/courses/course-agenda-designer.png" width="100%" class="img-thumbnail" alt="Thumbnail Image">
